...
export async function getRoutes() {
  return {
    routes: {"1":{"path":"/","name":"index","icon":"smile","parentId":"ant-design-pro-layout","id":"1"},"2":{"path":"/interface_info/:id","parentId":"ant-design-pro-layout","id":"2"},"3":{"path":"/user","layout":false,"id":"3"},"4":{"name":"login","path":"/user/login","parentId":"3","id":"4"},"5":{"name":"login","path":"/user/register","parentId":"3","id":"5"},"6":{"path":"/admin","name":"管理页","icon":"crown","access":"canAdmin","parentId":"ant-design-pro-layout","id":"6"},"7":{"name":"接口管理","icon":"table","path":"/admin/interface_info","parentId":"6","id":"7"},"8":{"name":"接口分析","icon":"analysis","path":"/admin/interface_analysis","parentId":"6","id":"8"},"9":{"path":"*","layout":false,"id":"9"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true}},
    routeComponents: {
